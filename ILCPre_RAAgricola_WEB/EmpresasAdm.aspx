<%@ Page Title="" Language="C#" MasterPageFile="~/Inicio.Master" AutoEventWireup="true" CodeBehind="EmpresasAdm.aspx.cs" Inherits="Cabana.Campo.RAAgricola.Pre.Web.EmpresasAdm" %>
    ...
    <form role="form" id="form" runat="server">
                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#tab-1"><i class="fa fa-user"></i>Registro de Empresas</a></li>
                            </ul>
        ...
        <div class="table-responsive">
         ...
         <ContentTemplate>
                ...
                <p>Nombre de Cliente o Empresa</p>
                <asp:TextBox ID="txt_EmprNombre" runat="server" class="input form-control"></asp:TextBox> 
                    <span class="help-block m-b-none"> </span>

                <p>Nombre de Contacto</p>
                <asp:TextBox ID="txt_EmprNomContacto" runat="server" class="input form-control"></asp:TextBox> 

                <p>Numero de Telefono</p>
                <asp:TextBox ID="txt_EmprTelefono" runat="server" class="input form-control"></asp:TextBox> 
                    <span class="help-block m-b-none"> </span>

                <p>Direccion</p>
                <asp:TextBox ID="txt_EmprDireccion" runat="server" class="input form-control"></asp:TextBox> 
                    <span class="help-block m-b-none"> </span>

                <p>Alias</p>
                <asp:TextBox ID="txt_EmprAlias" runat="server" class="input form-control" MaxLength="5"></asp:TextBox> 
                    <span class="help-block m-b-none"> </span>
         ...
         <ContentTemplate>                           
                            ...
                            <br />
                            <div class="clients-list">
                                <span class="pull-right small text-muted">Listado de Empresas</span>
                            <ul class="nav nav-tabs">
        ...
        <ContentTemplate>
            ...
            Container.DataItem,"EmprId") %>'></asp:Label>
                                    </ItemTemplate>
                                    <EditItemTemplate>           
            ...
            Container.DataItem, "EmprNombre") %>'></asp:Label>
                                    </ItemTemplate>
            ...
            Container.DataItem,"EmprAlias") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
            ...
            Container.DataItem,"EmprNomContacto") %>'></asp:Label>
