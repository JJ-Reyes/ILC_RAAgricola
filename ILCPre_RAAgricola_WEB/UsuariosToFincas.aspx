<%@ Page Title="" Language="C#" MasterPageFile="~/Inicio.Master" AutoEventWireup="true" CodeBehind="UsuariosToFincas.aspx.cs" Inherits="Cabana.Campo.RAAgricola.Pre.Web.UsuariosToFincas" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContenedorEncabezado" runat="server">
                        <h2>Asignacion de Fincas a Usuarios</h2>
                    <ol class="breadcrumb">
                        <li>
    ...
    <form role="form" id="form" runat="server">
        ...
        <div class="table-responsive">
         ...
         <ContentTemplate>
                ...
                <p>Proveedor Finca</p>
                <asp:DropDownList ID="ddl_FincasProv" runat="server" class="form-control m-b" >
                    <asp:ListItem value ="0">Seleccione una Finca</asp:ListItem>

                </asp:DropDownList>
                    <span class="help-block m-b-none"> </span>

                <asp:LinkButton ID="lbtn_AddNewTarea" runat="server" class="btn btn btn-primary"  OnClick="lbtn_AddNewAccesoUsuFincas_Click">Agregar Usuario <i class="fa fa-save"></i></asp:LinkButton>
         ...
         <ContentTemplate>                           
                            <div class="input-group">
                                ...
                                <asp:TextBox ID="txtControlBuscarTareas" runat="server" Text="" AutoPostBack="true" OnTextChanged="lbtnBuscarAccesoUsuFincas_Click"  class="input form-control" ></asp:TextBox>
                                <span class="input-group-btn">
                                    <asp:LinkButton ID="lbtnBuscarTarea" runat="server" class="btn btn btn-warning"  OnClick="lbtnBuscarAccesoUsuFincas_Click">Buscar <i class="fa fa-search"></i></asp:LinkButton>
        ...
        <ContentTemplate>
                           <asp:GridView class="table table-striped table-hover" ID="gvAccesoUsuFincas" GridLines="None" BorderStyle="None" BorderColor="White" runat="server" Width="100%" AllowPaging="True"  OnPageIndexChanging="gvAccesoUsuFincas_PageIndexChanging"  AllowSorting="True"
                                AutoGenerateColumns="false" ShowFooter="true" ShowHeaderWhenEmpty="true"
                                onrowcommand="gvAccesoUsuFincas_RowCommand"
                                onrowdeleting="gvAccesoUsuFincas_RowDeleting"
                                onrowcancelingedit="gvAccesoUsuFincas_RowCancelingEdit"
                                onrowediting="gvAccesoUsuFincas_RowEditing"
                                onrowupdating="gvAccesoUsuFincas_RowUpdating"
                                >
                            <Columns> 
            ...
            Container.DataItem,"AccUsuId") %>'></asp:Label>
                                    </ItemTemplate>
                                    <EditItemTemplate>           
            ...
            Container.DataItem,"UsuNombreCompleto") %>'></asp:Label>
                                ...
                                <asp:TemplateField HeaderText="IDFinca">
                                    <ItemTemplate>
            ...
            Container.DataItem,"ProvId") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>	                                                                                                                                                              	                                                                			
